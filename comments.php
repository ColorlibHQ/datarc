...
?>
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <h4 class="m-text25 p-b-14"><?php printf( _nx( '1 Comment', '%1$s Comments', get_comments_number(), 'comments title', 'datarc' ), number_format_i18n( get_comments_number() ) ); ?></h4>
            ...
            <ul class="commentlist">
                <?php
                    wp_list_comments( array(
                        ...
                        'short_ping'  => true,
                        'avatar_size' => 70,
                        'callback'    => 'datarc_comment_callback'
                    ) );
                ?>
            </ul><!-- .comment-list -->
        <?php the_comments_navigation(); ?>
    ...
    ?>
        <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'datarc' ); ?></p>
    <?php endif; ?>
...
<?php
	...
	$args=array(
	'comment_field'         =>'<textarea id="cMessage" class="dis-block s-text7 size18 bo12 p-l-18 p-r-18 p-t-13 m-b-20 m-t-20" name="comment" placeholder="'.esc_attr__( 'Comment...', 'datarc' ).'"></textarea>',
	'id_form'               =>'contactForm',
    'class_form'            =>'',
	'title_reply'           =>esc_html__( 'LEAVE A COMMENT', 'datarc' ),
	'title_reply_before'    =>'<h4 class="m-text25 p-b-14">',
	'title_reply_after'     =>'</h4>',
    'label_submit'          => esc_html__( 'Post Comment', 'datarc' ),
