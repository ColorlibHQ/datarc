	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }}">
			<h3 class="accordion-section-title" tabindex="0">
				{{ data.title }}
				<span class="screen-reader-text"><?php _e( 'Press return or enter to open this section', 'datarc' ); ?></span>
			</h3>
			<ul class="accordion-section-content">
				<li class="customize-section-description-container section-meta <# if ( data.description_hidden ) { #>customize-info<# } #>" >
					<button type="button" class="button epsilon-close-doubled-section" aria-expanded="false" aria-controls="available-sections">
						<span class="screen-reader-text"><?php esc_html_e( 'Close', 'datarc' ); ?></span>
					</button>
					<div class="customize-section-title">
						...
						<# if ( data.description && data.description_hidden ) { #>
							<button type="button" class="customize-help-toggle dashicons dashicons-editor-help" aria-expanded="false"><span class="screen-reader-text"><?php _e( 'Help', 'datarc' ); ?></span></button>
