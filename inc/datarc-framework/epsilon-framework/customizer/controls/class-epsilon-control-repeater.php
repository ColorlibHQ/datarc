...
class Epsilon_Control_Repeater extends WP_Customize_Control {
	...
	public function json() {
		...
		$json['buttonLabel']  = ( isset( $this->button_label ) ) ? $this->button_label : __( 'Add', 'datarc' );
	...
	public function content_template() {
		...
		<p class="limit"><?php echo esc_html__( 'Limit: ','datarc' ); ?> {{{ data.choices.limit }}} <?php echo esc_html__( 'sections', 'datarc' ); ?></p>
		<# } #>
