...
class Epsilon_Control_Image_Dimensions extends WP_Customize_Control {
	...
	public function content_template() {
		...
		<div class="epsilon-controller-image-dimensions-container">
			<div class="col-4">
				<label for="{{ data.id }}-width" class="mini-label"><?php esc_html_e('Width', 'datarc'); ?></label>
				<input type="text" id="{{ data.id }}-width" data-type="width" value="{{ data.value.width }}"/>
			</div>
			<div class="col-4">
				<label for="{{ data.id }}-height" class="mini-label"><?php esc_html_e('Height', 'datarc'); ?></label>
				<input type="text" id="{{ data.id }}-height" data-type="height" value="{{ data.value.height }}"/>
			</div>
			<div class="col-4">
				<label for="{{ data.id }}-ratio" class="mini-label"><?php esc_html_e('Ratio', 'datarc'); ?></label>
