			...
			switch ( $prop ) {
				case 'background-color':
					$temp = array(
						...
						'label'       => __( 'Background color', 'datarc' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'epsilon-color-picker',
						'mode'        => 'hex',
				...
				case 'background-color-opacity':
					$temp = array(
						...
						'label'       => __( 'Background color opacity', 'datarc' ),
						'description' => '',
						'type'        => 'epsilon-slider',
				...
				case 'background-image':
					$temp = array(
						...
						'label'       => __( 'Background image', 'datarc' ),
						'description' => '',
						'type'        => 'epsilon-image',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'group'       => 'styling',
				...
				case 'background-position':
					$temp = array(
						...
						'label'       => __( 'Background position', 'datarc' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'topleft'     => __( 'Top Left', 'datarc' ),
							'top'         => __( 'Top', 'datarc' ),
							'topright'    => __( 'Top Right', 'datarc' ),
							'left'        => __( 'Left', 'datarc' ),
							'center'      => __( 'Center', 'datarc' ),
							'right'       => __( 'Right', 'datarc' ),
							'bottomleft'  => __( 'Bottom Left', 'datarc' ),
							'bottom'      => __( 'Bottom', 'datarc' ),
							'bottomright' => __( 'Bottom Right', 'datarc' ),
						),
					);
				...
				case 'background-repeat':
					$temp = array(
						...
						'label'       => __( 'Background repeat', 'datarc' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'no-repeat' => __( 'No Repeat', 'datarc' ),
							'repeat'    => __( 'Repeat', 'datarc' ),
							'repeat-y'  => __( 'Repeat Y', 'datarc' ),
							'repeat-x'  => __( 'Repeat X', 'datarc' ),
						),
					);
				...
				case 'background-size':
					$temp = array(
						...
						'label'       => __( 'Background size', 'datarc' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'select',
						'group'       => 'styling',
						'choices'     => array(
							'cover'   => __( 'Cover', 'datarc' ),
							'contain' => __( 'Contain', 'datarc' ),
							'initial' => __( 'Initial', 'datarc' ),
						),
					);
				...
				case 'background-parallax':
					$temp = array(
						...
						'label'       => __( 'Background parallax', 'datarc' ),
						'description' => '',
				...
				case 'background-video':
					$temp = array(
						...
						'label'       => __( 'Background video', 'datarc' ),
						'description' => '',
						'default'     => isset( $values['default'] ) ? $values['default'] : '',
						'type'        => 'text',
						'group'       => 'styling',
			...
			switch ( $prop ) {
				case 'column-alignment':
					$temp = array(
						...
						'label'   => __( 'Horizontal alignment', 'datarc' ),
						'group'   => 'layout',
				...
				case 'column-vertical-alignment':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Vertical alignment', 'datarc' ),
						'group'   => 'layout',
				...
				case 'row-spacing-bottom':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Spacing bottom', 'datarc' ),
						'group'   => 'layout',
				...
				case 'row-title-align':
					$temp              = array(
						...
						'type'    => 'epsilon-button-group',
						'label'   => __( 'Title & description alignment', 'datarc' ),
						'group'   => 'layout',
