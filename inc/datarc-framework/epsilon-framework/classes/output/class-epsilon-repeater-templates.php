			...
			<li class="repeater-row minimized" data-row="{{{ index }}}">
				...
				<div class="repeater-row-content">
					...
					<div class="repeater-row-footer">
						<button type="button" class="button-link repeater-row-remove"><?php esc_attr_e( 'Remove', 'datarc' ); ?></button> |
						<button type="button" class="button-link repeater-row-minimize"><?php esc_attr_e( 'Close', 'datarc' ); ?></button>
					</div>
				</div>
			</li>
		</script>
		...
		<# var field; var index = data.index; #>
			<li class="repeater-row minimized" data-row="{{{ index }}}">
				...
				<div class="repeater-row-content">
					...
					<nav>
						<# if( data.customization.enabled ) { #>
							<a href="#" class="active" data-item="regular"><span class="dashicons dashicons-welcome-write-blog"></span> <span class="label"><?php echo __('Content' ,'datarc'); ?></span></a>
						<# } #>
						<# if( ! _.isEmpty(data.customization.styling) ) { #>
							<a href="#" data-item="styling"><span class="dashicons dashicons-admin-customizer"></span> <span class="label"><?php echo __('Style' ,'datarc'); ?></span></a>
						<# } #>
						<# if( ! _.isEmpty(data.customization.layout) ) { #>
							<a href="#" data-item="layout"><span class="dashicons dashicons-layout"></span> <span class="label"><?php echo __('Layout' ,'datarc'); ?></span></a>
						<# } #>
						<# if( ! _.isEmpty(data.customization.colors) ) { #>
							<a href="#" data-item="colors"><span class="dashicons dashicons-admin-appearance"></span> <span class="label"><?php echo __('Colors' ,'datarc'); ?></span></a>
						<# } #>
					<# } #>
					</nav>
					<# _.each( data, function( field, i ) { #>
	...
	public static function epsilon_image() {
		...
		<div class="epsilon-controller-image-container image-upload">
			...
			<div class="placeholder">
				<?php echo esc_html__( 'Upload image', 'datarc' ); ?>
				<# if ( ! _.isUndefined( field.sizeArray[field.size] ) ) { #>
				<span class="recommended-size"><?php echo esc_html__( 'Recommended resolution:', 'datarc' ); ?>
			...
			<div class="actions">
				...
				<?php esc_attr_e( 'Remove', 'datarc' ); ?>
				</button>

				<button type="button" class="button-primary image-upload-button">
					<?php echo esc_html__( 'Select File', 'datarc' ); ?>
				</button>
			</div>
		</div>
		<?php
	...
	public static function epsilon_picker() {
		...
		<label>
			...
			<span class="customize-control-title epsilon-color-picker-title">
				{{{ field.label }}}
				<a href="#" data-default="{{ field.defaultVal }}" class="epsilon-color-picker-default"><?php echo esc_html__( '(clear)', 'datarc' ); ?></a>
				<# if( field.description ){ #>
