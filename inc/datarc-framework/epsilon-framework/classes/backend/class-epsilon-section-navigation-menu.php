		...
		<div class="customlinkdiv" id="epsilon-section-navigation-menu">
			...
			<p id="menu-item-url-wrap" class="wp-clearfix">
				...
				<select id="epsilon-section-id"
					...
					<option value="0"><?php esc_html_e( 'Select a Section', 'datarc' ); ?></option>
			...
			<p>
				<?php esc_html_e('Only sections that have an ID are selectable, please edit section id\'s to see all the sections!', 'datarc');?>
			</p>
			<p class="button-controls wp-clearfix">
			<span class="add-to-menu">
				<input type="submit" <?php wp_nav_menu_disabled_check( $nav_menu_selected_id ); ?>
				       class="button submit-add-to-menu right"
				       value="<?php esc_attr_e( 'Add to Menu', 'datarc' ); ?>"
