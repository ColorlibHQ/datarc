...
class Epsilon_Framework {
	 ...
	 * @var mixed|string
	 */
	private $path = '/inc/datarc-framework';
	/**
	...
	public function customizer_enqueue_scripts() {
		...
		wp_localize_script( 'epsilon-object', 'EpsilonTranslations', array(
			'remove'     => esc_html__( 'Remove', 'datarc' ),
			'add'        => esc_html__( 'Add', 'datarc' ),
			'selectFile' => esc_html__( 'Upload image', 'datarc' ),
			'row'        => esc_html__( 'Row', 'datarc' ),
		) );
