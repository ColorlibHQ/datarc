...
// image default alt
if( !function_exists( 'datarc_img_default_alt' ) ){
	function datarc_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'datarc_img_tag' ) ){
	function datarc_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = datarc_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'datarc_anchor_tag' ) ){
	function datarc_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'datarc_heading_tag' ) ){
	function datarc_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'datarc_paragraph_tag' ) ){
	function datarc_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'datarc_other_tag' ) ){
	function datarc_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'datarc_button_element ' ) ){
	function datarc_button_element( array $args ){
