	...
	foreach ( $this->plugins as $plugin => $prop ) {
		...
		<div class="col plugin_box">
			...
			<?php if ( $prop['recommended'] ) { ?>
				<span class="recommended"><?php echo esc_html__( 'Recommended', 'datarc' ); ?></span>
			<?php } ?>

			<img src="<?php echo esc_attr( $info['icon'] ); ?>" alt="plugin box image">
			<span class="version"><?php echo esc_html__( 'Version:', 'datarc' ); ?><?php echo esc_html( $info['info']->version ); ?></span>
