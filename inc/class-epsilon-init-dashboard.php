...
class Epsilon_init_Dashboard {
	...
	private function _notify_feedback() {
		...
		$html .=
			...
			// Translators: 1 is Theme Name, 2 is opening Anchor, 3 is closing.
				__( 'We\'ve been working hard on making %1$s the best one out there. We\'re interested in hearing your thoughts about %1$s and what we could do to make it even better. %2$sSend your feedback our way%3$s.', 'datarc' ),
				array(
					'Datarc',
					'<a target="_blank" href="https://bit.ly/feedback-datarc">',
					'</a>',
				)
			);
		...
		$notifications->add_notice(
			array(
				'id'      => 'datarc_notification_feedback',
	...
	public function init_nav_menus() {
		new Epsilon_Section_Navigation_Menu( 'datarc_frontpage_sections_' );
	}
