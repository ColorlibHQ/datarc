...
function datarc_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'datarc' ),
        'next_string'     => esc_html__( '&raquo;', 'datarc' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'datarc_pagination_defaults', $defaults )
    );
